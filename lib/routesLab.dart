...
import "package:heidi_flutter/main2.dart";
      ...
      ( children: 
        [ Text("Page 1", style:ts),
          ...
          ( onPressed: ()
            ...
            child: Text("go FORWARD to page 2", style:ts),
          ...
          { Navigator.of(context).push
            ...
            child: Text("skip FORWARD to page 3", style:ts),
          ),
        ],
      ),
    );
            ...
            ( children: 
              [ Text("Page 2", style:ts),
                ...
                { Navigator.of(context).push
                  ...
                  child: Text("go FORWARD to page 3", style:ts),
                ),
                ElevatedButton
...
//third page added for splash lab
            ...
            body: Column(
              children:
                [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).pop(); // Pop Route3
                      Navigator.of(context).popUntil((route) => route.settings.name == '/'); // Pop until Route1 ("/" route)
                    },
                    child: Text("skip BACK to page 1", style: ts),
                  )
